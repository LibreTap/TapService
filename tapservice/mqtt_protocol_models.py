...
Last generated: 2025-11-13 22:18:32 UTC
"""
...
#   filename:  schemas
#   timestamp: 2025-11-13T22:18:32+00:00
...
class ReadStart(BaseModel):
    """
    v1.0: Tag discovery only (returns tag_uid). Block reading planned for v2.0.
    """
...
class SuccessRegisterRead(BaseModel):
    """
    Success payload for register and read operations. Note: v1.0 read returns only tag_uid (no block data).
    """

    tag_uid: Annotated[str, Field(pattern='^([0-9A-Fa-f]{2}:)+[0-9A-Fa-f]{2}$')]
    blocks_written: Annotated[
        Optional[int],
        Field(description='Only present for register_success events', ge=0),
    ] = None
    message: str
